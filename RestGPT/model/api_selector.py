...
Background: The authorId of Eminem is 6747746048460915718
User query: give me count of subscribers, clips, likes and  url by Eminem.
API calling 1: GET api/datapoint/author?authorId=6747746048460915718 to get the additional information about Eminem
API response: The Eminem account url is "https://www.tiktok.com/@6664511694575157253", that has 744400 subscribers, 2531 clips and 8200000 likes. 

Example 2:

Background: No background
User query: search top 3 more rate music from Brazil 
API calling 1: GET /api/datapoint/sounds?sorting=rate&take=3&VideosLocation=BR to get list of sounds according to request
API response: Top 5 music from Brasil sorted by rate: 
1. Sound name is "som original" ("title") created by "vivi" ("creator") with id 7340668359380781830 ("musicId")
2. Sound name is "soriginal sound" ("title") created by "I eat rats" ("creator") with id 7340660231057214240 ("musicId")
3. Sound name is "som original" ("title") created by "adry borbara" ("creator") with id 7322969874021665541 ("musicId")

Example 3:

Background: No background
User query: Show me avatars of authors, that have more than 10 and less than 1000000 subscribers for last 50 days
API calling 1: GET /api/datapoint/authors?take=10&SubscribersTo=1000000&SubscribersFrom=10&Days=50 to search authors authorId
API response: {{"authorId": "6867459340397102086", "subscribers"},{"authorId": "6787120007023019014", "subscribers"},...}
Instruction: Continue. Search for avatars for all users using authorId one by one
API calling 2: GET /api/datapoint/author?authorId=6867459340397102086 to get avatar for author with authorId=6867459340397102086,
GET /api/datapoint/author?authorId=6787120007023019014 to get avatar for for user with authorId=6787120007023019014...
API response: Avatars of authors: 
1. "authorId": "6867459340397102086", "avatar": "https://p16-sign-va.tiktokcdn.com/f5fc5_100x100.jpeg 
1. "authorId": "6787120007023019014", "avatar": "https://p16-sign-va.tiktokcdn.com/signature=pBLnlqq%2BsEqK9JAAvKX%2ByuyzKN0%3D...  
""",
    "tmdb": """Example 1:
